...
export default function HeroSlider() {
  return (
    <div>
      ...
      >
        <SwiperSlide
          className="bg-[url('/slide/slide-1.png')] bg-no-repeat bg-center md:bg-right px-16 md:p-20 items-center"
          style={{
            display: "flex",
          }}
        >
          <div className="max-w-3xl">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-6xl mb-4 font-sans font-bold">
            ...
            <a
              href="/"
              className="text-sm bg-accent-gradient px-6 py-3 rounded-xl border border-yellow-400 uppercase hover:opacity-70"
            >
              Play Unfair Mario
            </a>
          </div>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="max-w-[418px] mb-6">play something</p>
            <a
              href="/"
              className="text-sm bg-accent-gradient px-6 py-3 rounded-xl border border-yellow-400 uppercase hover:opacity-70"
            >
